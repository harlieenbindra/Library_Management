...
CREATE TABLE `books_issued` (
  ...
  `studentid` bigint(15) unsigned NOT NULL,
  `issuedate` date NOT NULL,
  PRIMARY KEY (`studentid`,`bookcallno`),
  KEY `callno_idx` (`bookcallno`)
...
INSERT INTO `books_issued` VALUES ('b@2',60311502714,'2017-01-06'),('b@2',60411502714,'2017-01-10'),('b@7',60411502714,'2017-01-06'),('b@1',60511502714,'2017-01-06'),('b@2',60511502714,'2017-03-31'),('b@7',60511502714,'2017-01-06');
